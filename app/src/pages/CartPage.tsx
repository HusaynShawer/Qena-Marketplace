    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 page-enter">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {cart.map((item: { id: number; product_id: number; quantity: number; product?: { name: string; price: number; image_url: string } }) => (
          ...
          <div className="card p-6 sticky top-24">
            ...
            <div className="space-y-3 text-sm mb-5">
              <div className="flex justify-between text-slate-600">
                <span>Subtotal ({cart.reduce((s: number, i: { quantity: number }) => s + i.quantity, 0)} items)</span>
