...
const SellerSetup: React.FC = () => {
  ...
  // Check if they already have a seller profile
  useEffect(() => {
    api.get('/sellers/me')
      .then(res => {
  ...
  if (checking) return (
    <div className="min-h-screen flex items-center justify-center text-gray-500">Checking status…</div>
  )

  // Already applied and approved → go to seller dashboard
  if (alreadyApplied && approved) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-4 text-center">
        <div className="text-5xl">✅</div>
        <h2 className="text-2xl font-bold text-gray-900">Your shop is approved!</h2>
        <p className="text-gray-500">You can manage your products and orders from the seller dashboard.</p>
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-4 text-center">
        ...
        <p className="text-gray-500 max-w-sm">
          Your seller application has been submitted. An admin will review it and approve your account shortly.
        </p>
      ...
      <div className="bg-white rounded-2xl shadow-md w-full max-w-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Fill in your shop details. After submitting, an admin will approve your account.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          ...
          <a href="/seller" className="text-orange-600 hover:underline">Go to dashboard</a>
        </p>
      </div>
    </div>
  )
